/* Kiss Cam — FINAL CLEAN FIXED VERSION */
...
function createHeart(x,y,big=false){
    ...
    el.innerHTML = `
        <svg viewBox="0 0 32 29" width="100%" height="100%">
            <path fill="#ff2a2a"
            d="M23.6 2.6c-2.4 0-4.6 1.3-5.6 3.3-1-2-3.2-3.3-5.6-3.3C5.4 2.6 2 6 2 10.1c0 6.1 10.6 
            12.1 14 16.9 3.4-4.8 14-10.8 14-16.9 0-4.1-3.4-7.5-6.4-7.5z"/>
        </svg>
    `;
    ...
    requestAnimationFrame(()=>{
        ...
        el.style.opacity = 1;
        el.style.transform =
            `translate(${dx}px,${dy}px) scale(${1+Math.random()}) rotate(${Math.random()*360}deg)`;
    });
